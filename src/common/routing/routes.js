  ...
  return asyncComponent({
    ...
    ErrorComponent() {
      return ( <
        ...
        Icon name = "refresh" / >
        Refresh <
        Header.Subheader > Got error
        while loading page. < /Header.Subheader> <
        /Header> <
        /Dimmer>
      )
    },
...
function routingFnCreator(useFor: 'sidebar' | 'routing' | 'meta' | 'all' = 'all') {
  const [AsyncDashboard, AsyncLogin, AsyncSignup, AsyncLinks,
    AsyncRegionSearch, AsyncRegionAdd, AsyncRegionEdit, AsyncRegionView,
    AsyncCountrySearch, AsyncCountryAdd, AsyncCountryEdit, AsyncCountryView,
    AsyncLocationSearch, AsyncLocationAdd, AsyncLocationEdit, AsyncLocationView,
    AsyncDepartmentSearch, AsyncDepartmentAdd, AsyncDepartmentEdit, AsyncDepartmentView,
    AsyncTaskSearch, AsyncTaskAdd, AsyncTaskEdit, AsyncTaskView,
    AsyncEmployeeSearch, AsyncEmployeeAdd, AsyncEmployeeEdit, AsyncEmployeeView,
    AsyncJobSearch, AsyncJobAdd, AsyncJobEdit, AsyncJobView,
    AsyncJobHistorySearch, AsyncJobHistoryAdd, AsyncJobHistoryEdit, AsyncJobHistoryView,
    AsyncNotFound
  ] = [
    'Dashboard',
    'Login',
    'Signup',
    'Links',
    'region/search', 'region/add', 'region/edit', 'region/view',
    'country/search', 'country/add', 'country/edit', 'country/view',
    'location/search', 'location/add', 'location/edit', 'location/view',
    'department/search', 'department/add', 'department/edit', 'department/view',
    'task/search', 'task/add', 'task/edit', 'task/view',
    'employee/search', 'employee/add', 'employee/edit', 'employee/view',
    'job/search', 'job/add', 'job/edit', 'job/view',
    'jobhistory/search', 'jobhistory/add', 'jobhistory/edit', 'jobhistory/view',
    'NotFound'
  ...
  const routes: Array < RouteItem > = [{
    ...
    },
    {
      ...
      tag: RouteAuth,
      canAccess: isLoggedIn,
      component: AsyncJobHistorySearch,
      meta: {
        name: 'Job History',
        icon: 'bookmark',
        sidebarVisible: true
    ...
    },
    {
      ...
      tag: RouteAuth,
      canAccess: isLoggedIn,
      component: AsyncJobHistoryEdit,
      meta: {
        name: 'Edit Job History',
        sidebarVisible: false
      }
    },
    {
      path: '/viewJobHistory/:id',
      exact: true,
      tag: RouteAuth,
      canAccess: isLoggedIn,
      component: AsyncJobHistoryView,
      meta: {
